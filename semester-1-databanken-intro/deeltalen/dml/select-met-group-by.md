...
Als je wil weten hoe veel honden van elk geslacht er zijn, schrijf je dit (0036__CreateHonden.sql):
...
Daarmee zie je per geslacht hoe veel honden er zijn. De tussenliggende tabel is een hulpmiddel om hierover na te denken; volgende code zou niet werken:
